		...
		<Root className={classes.root}>
			<div className={classes.outerContainer}>
				<div style={{ width: '100%', display: Object.keys(comments).length ? 'block' : 'none' }}>
					<Typography gutterBottom variant="h6" style={{ fontFamily:'Nunito', fontWeight:'bold' }}>
						Comments
					</Typography>
					<div className={classes.innerContainer}  style={{ fontFamily:'Nunito', fontWeight:'bold' }}>
				...
				<div style={{ width: '100%', display: userId ? 'block' : 'none',  fontFamily:'Nunito',  }}>
					<Typography gutterBottom variant="h6">Write a comment</Typography>
					<TextField InputProps={{ style: { color: 'black', fontFamily:'Nunito', } }} fullWidth rows={10} variant="outlined" label="Comment" multiline value={comment} onChange={(e) => setComment(e.target.value)} />
					<Button style={{ marginTop: '10px', fontFamily:'Nunito', fontWeight:'bold' }} fullWidth disabled={!comment.trim().length} color="primary" variant="contained" onClick={handleComment}>
						Comment
					</Button>
				</div>
			</div>
