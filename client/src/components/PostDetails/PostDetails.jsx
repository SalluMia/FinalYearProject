...
const PostDetails = ({ user }) => {
	...
	return isLoading || !post ? (
		...
		<Root className={classes.root}>
					...
					<Grid item xs={12} sm={12} md={6} lg={7}>
						<div className={classes.card}>
							<div className={classes.section}>
								...
								<Typography variant="body1"  className={classes.Datedata} >{moment(post.createdAt).format('Do MMMM YYYY, dddd, h:mm A')}</Typography>
			...
			<Paper className={classes.loadingPaper} elevation={0} sx={{ marginTop: 1 }}>
