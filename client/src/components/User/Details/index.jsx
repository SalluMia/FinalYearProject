	...
	return (
		<Root className={classes.root}>
			<div className={classes.userContainer}>
				<Paper className={classes.userIcon} elevation={0}>
					{user.result.avatar ? (
				...
				<Paper className={classes.userDetails} elevation={6}>
					{progress < 100 || isLoading ? (
						<Box className={classes.loadingLine}>
							<Typography color="black">Loading User Details ...</Typography>
							...
							<Box>
								<Typography color="black">
									...
									<Tooltip title="Post with longest message">
										<Link to={`/posts/${longestPostId}`} style={{ color: 'black', textDecoration: 'none' }}>{`${longestPostWords} Words`}</Link>
									</Tooltip>
								</Typography>
								<Divider />
							</Box>
							<div className={classes.tagsContainer}>
								<Typography color="black" style={{ whiteSpace: 'nowrap' }}>
